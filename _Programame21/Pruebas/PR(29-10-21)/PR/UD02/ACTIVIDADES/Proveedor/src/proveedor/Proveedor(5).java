...
public class Proveedor {
    ...
    String todosDatosProveedor() {
        return "Proveedor " + "CIF=" + cif + ", Nombre Empresa=" + nombreEmpresa + 
                ", Descripcion=" + descripcion + ", Sector=" + sector + 
                ", Direccion=" + direccion + ", Telefono=" + telefono + 
                ", Poblacion=" + poblacion + ", Cod Postal=" + codPostal + 
                ", Correo=" + correo;
    }
           
    // METODO verificaCorreo QUE DEVUELVE TRUE SI LA DIRECCION DE CORREO CONTIENE @.
    boolean verificaCorreo(){
        return ((correo.indexOf("@") >= (0))? true:false); 
        //return (correo.indexOf("@") >= (0)); OTRAS OPCIONES
