...
public class Numero {
    ...
    int anade(int numUsuario) {
        return (this.numeroInterno= this.numeroInterno + numUsuario);
    }

    // METODO QUE DISMINUYE EL VALOR DE NUMERO INTERNO
    int resta(int numUsuario) {
        return (this.numeroInterno= this.numeroInterno - numUsuario);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El valor de numero interno ahora es: " + prueba1.anade(numUsuario));
        System.out.println("Ahora indica el numero que desea restar a la cantidad de numero interno: ");
        numUsuario= teclado.nextInt();
        System.out.println("La resta da como resultado: " + prueba1.resta(numUsuario));
