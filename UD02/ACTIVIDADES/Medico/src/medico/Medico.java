...
public class Medico {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Introduce los datos de medico traumatologo: ");
        System.out.print("Codigo medico: ");
        usrCodMedico = teclado.nextLine();
        System.out.print("Nombre: ");
        usrNombre = teclado.nextLine();
        ...
        System.out.println("El nuevo salario de medico traumatologo es: " 
                + medicoTraumatologo.getSueldo() + "\n");
        
        System.out.println("");
        usrDni= teclado.nextLine();
        
        System.out.print("Realiza un cambio en el DNI de medico digestivo");
        usrDni= teclado.nextLine();
        medicoDigestivo.setDni(usrDni);
        System.out.println("El nuevo DNI de medico digestivo es: " 
        ...
        System.out.println("La retencion de medico digestivo es: " 
                + medicoDigestivo.retencionMedico(usrRetencion));
        System.out.println(" La retencion de medico traumatologo es: " 
                + medicoTraumatologo.retencionMedico(usrRetencion) + "\n");
       
        System.out.println("Medico digestivo: " + medicoDigestivo.mostrarDatos() 
                + " Retencion: " + medicoDigestivo.retencionMedico(usrRetencion) 
                + " Salario final: " + (medicoDigestivo.getSueldo() 
                        - medicoDigestivo.retencionMedico(usrRetencion)) + "\n");
        
        System.out.println("Medico traumatologo: " + medicoTraumatologo.mostrarDatos() 
